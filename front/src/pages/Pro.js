    ...
    <div class="container">
      ...
      <div className='pro_img'>
        ...
        <div id="r1" className="carousel carousel-dark slide" data-bs-ride="carousel">
          ...
          <button className='color1' type='button'></button>
          <button className='color2' type='button'></button>
          <button className='color3' type='button'></button>
          <button className='color4' type='button'></button>
          {/* 색깔별 버튼 임시 */}
      ...
      <div class="row">
          ...
          <div className="mx-auto" style={{ width: '18rem' }}>
            ...
            <div class="card-body">
              ...
              <Link to="/R1" className="card-link mx-3" style={cardStyle}>
                <button className='pro_btn'>구매</button></Link>
            </div>
          </div>
        </div>
        <div class="col mx-1 my-4" >
          <div className="mx-auto" style={{ width: '18rem' }}>
            ...
            <div class="card-body">
              ...
              <p class="card-text">알아서 받아주는 <br />촤고급 로봇 쓰레기통</p>
            </div>
            <br />
            <div class="card-body">
               74900원
              <Link to="/R2" className="card-link mx-3" style={cardStyle}> 
              <button className='pro_btn'>구매</button>
              </Link>
            </div>
          </div>
        </div>
        <div class="col mx-1 my-4" >
          <div className="mx-auto" style={{ width: '18rem' }}>
            ...
            <div class="card-body">
              159000원
              <Link to="/R3" className="card-link mx-3" style={cardStyle}> 
              <button className='pro_btn'>구매</button>
              </Link>
            </div>
          </div>
